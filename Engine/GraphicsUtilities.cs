...
namespace PlatformEngine
{
    ...
    public class GraphicsUtilities : IDrawableObject
    {
        ...
        public void Draw()
        {
            ...
            if (sShapeList.Count > 0)
            {
                ...
                foreach (ShapeData shapeData in sShapeList)
                {
                    ...
                    mBasicShapeEffect.Texture = shapeData.mTexture;
                    mBasicShapeEffect.TextureEnabled = true;
            ...
            if (sLinesList.Count > 0)
            {
                ...
                mBasicLineEffect.Begin(SaveStateMode.SaveState);
        ...
        // Line-drawing data
        VertexDeclaration mBasicLineVertexDecl;
